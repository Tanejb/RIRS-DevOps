...
def test_login_success(client):
    client.post("/api/auth/register", json={"username": "carol", "password": "pwd"})
    resp = client.post("/api/auth/login", json={"username": "carol", "password": "pwd"})
...
def test_login_invalid_credentials(client):
    client.post("/api/auth/register", json={"username": "dave", "password": "pwd"})
    resp = client.post("/api/auth/login", json={"username": "dave", "password": "bad"})
...
def test_profile_with_token(client):
    client.post("/api/auth/register", json={"username": "erin", "password": "pwd"})
    login = client.post("/api/auth/login", json={"username": "erin", "password": "pwd"})
